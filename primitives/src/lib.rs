...
mod tests {
	...
	fn test_block_weights() {
		...
		assert_eq!(normal.max_extrinsic, Some(Weight::from_parts(349875586000, 3670016)));
		...
		assert_eq!(operational.max_extrinsic, Some(Weight::from_parts(474875586000, 4980736)));
