...
export const RUNTIME_SPEC_VERSION = 2293;
export const RUNTIME_IMPL_VERSION = 0;
export const LAOS_NODE_URL = "ws://127.0.0.1:9999";
export const ASSET_HUB_NODE_URL = "ws://127.0.0.1:9950";
export const RELAYCHAIN_NODE_URL = "ws://127.0.0.1:9944";
