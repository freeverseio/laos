...
impl<T: frame_system::Config> pallet_asset_metadata_extender::WeightInfo for WeightInfo<T> {
	...
	fn precompile_extend(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(13_961_993, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 109
			.saturating_add(Weight::from_parts(1_954, 0).saturating_mul(t.into()))
			// Standard Error: 109
			.saturating_add(Weight::from_parts(10_919, 0).saturating_mul(u.into()))
	...
	fn precompile_update(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(12_348_295, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 207
			.saturating_add(Weight::from_parts(1_349, 0).saturating_mul(t.into()))
			// Standard Error: 207
			.saturating_add(Weight::from_parts(9_375, 0).saturating_mul(u.into()))
	...
	fn precompile_balance_of(u: u32, ) -> Weight {
		...
		Weight::from_parts(2_361_801, 0)
			.saturating_add(Weight::from_parts(0, 3999))
			// Standard Error: 23
			.saturating_add(Weight::from_parts(1_871, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: `AssetMetadataExtender::ExtensionsCounter` (r:1 w:0)
	/// Proof: `AssetMetadataExtender::ExtensionsCounter` (`max_values`: None, `max_size`: Some(534), added: 3009, mode: `MaxEncodedLen`)
	...
	fn precompile_claimer_by_index(u: u32, ) -> Weight {
		...
		Weight::from_parts(8_007_944, 0)
			.saturating_add(Weight::from_parts(0, 4035))
			// Standard Error: 78
			.saturating_add(Weight::from_parts(13_328, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(2))
	}
	/// Storage: `AssetMetadataExtender::ExtensionsCounter` (r:1 w:0)
	/// Proof: `AssetMetadataExtender::ExtensionsCounter` (`max_values`: None, `max_size`: Some(534), added: 3009, mode: `MaxEncodedLen`)
	...
	fn precompile_extension_by_index(u: u32, ) -> Weight {
		...
		Weight::from_parts(11_477_430, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 91
			.saturating_add(Weight::from_parts(18_547, 0).saturating_mul(u.into()))
	...
	fn precompile_extension_by_location_and_claimer(u: u32, ) -> Weight {
		...
		Weight::from_parts(5_784_524, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 43
			.saturating_add(Weight::from_parts(5_525, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
	}
	/// Storage: `AssetMetadataExtender::TokenUrisByClaimerAndLocation` (r:1 w:0)
	/// Proof: `AssetMetadataExtender::TokenUrisByClaimerAndLocation` (`max_values`: None, `max_size`: Some(1080), added: 3555, mode: `MaxEncodedLen`)
	...
	fn create_token_uri_extension(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(11_046_412, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 79
			.saturating_add(Weight::from_parts(554, 0).saturating_mul(t.into()))
			// Standard Error: 79
			.saturating_add(Weight::from_parts(7_909, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `AssetMetadataExtender::TokenUrisByClaimerAndLocation` (r:1 w:1)
	...
	fn update_token_uri_extension(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(9_198_238, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 53
			.saturating_add(Weight::from_parts(484, 0).saturating_mul(t.into()))
			// Standard Error: 53
			.saturating_add(Weight::from_parts(6_290, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
