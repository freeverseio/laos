...
impl<T: frame_system::Config> pallet_asset_metadata_extender::WeightInfo for WeightInfo<T> {
	...
	fn precompile_extend(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(27_239_000, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 707
			.saturating_add(Weight::from_parts(6_001, 0).saturating_mul(t.into()))
			// Standard Error: 707
			.saturating_add(Weight::from_parts(22_371, 0).saturating_mul(u.into()))
	...
	fn precompile_update(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(22_768_500, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 708
			.saturating_add(Weight::from_parts(6_958, 0).saturating_mul(t.into()))
			// Standard Error: 708
			.saturating_add(Weight::from_parts(20_735, 0).saturating_mul(u.into()))
	...
	fn create_token_uri_extension(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(22_280_000, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 473
			.saturating_add(Weight::from_parts(3_955, 0).saturating_mul(t.into()))
			// Standard Error: 473
			.saturating_add(Weight::from_parts(15_142, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	/// Storage: `AssetMetadataExtender::TokenUrisByClaimerAndLocation` (r:1 w:1)
	...
	fn update_token_uri_extension(t: u32, u: u32, ) -> Weight {
		...
		Weight::from_parts(18_194_500, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 1_063
			.saturating_add(Weight::from_parts(4_432, 0).saturating_mul(t.into()))
			// Standard Error: 1_063
			.saturating_add(Weight::from_parts(13_573, 0).saturating_mul(u.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
}
