...
impl<T: frame_system::Config> pallet_precompiles_benchmark::WeightInfo for WeightInfo<T> {
	...
	fn precompile_vest() -> Weight {
		...
		Weight::from_parts(35_992_000, 0)
	...
	fn precompile_vest_other() -> Weight {
		...
		Weight::from_parts(36_598_000, 0)
			.saturating_add(Weight::from_parts(0, 4752))
			.saturating_add(T::DbWeight::get().reads(4))
			.saturating_add(T::DbWeight::get().writes(3))
	}
	...
	fn precompile_vesting(m: u32, ) -> Weight {
		...
		Weight::from_parts(6_444_336, 0)
			.saturating_add(Weight::from_parts(0, 4510))
			// Standard Error: 1_971
			.saturating_add(Weight::from_parts(44_162, 0).saturating_mul(m.into()))
