...
impl<T: frame_system::Config> pallet_laos_evolution::WeightInfo for WeightInfo<T> {
	...
	fn precompile_mint(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_357_623, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			// Standard Error: 86
			.saturating_add(Weight::from_parts(1_070, 0).saturating_mul(s.into()))
	...
	fn precompile_evolve(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_031_958, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			// Standard Error: 74
	...
	fn mint_with_external_uri(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_373_908, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			// Standard Error: 91
			.saturating_add(Weight::from_parts(2_159, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `LaosEvolution::CollectionOwner` (r:1 w:0)
	...
	fn evolve_with_external_uri(s: u32, ) -> Weight {
		...
		Weight::from_parts(12_449_345, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			// Standard Error: 75
			.saturating_add(Weight::from_parts(1_577, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `LaosEvolution::CollectionOwner` (r:1 w:1)
