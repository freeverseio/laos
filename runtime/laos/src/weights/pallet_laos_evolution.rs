...
impl<T: frame_system::Config> pallet_laos_evolution::WeightInfo for WeightInfo<T> {
	...
	fn precompile_create_collection() -> Weight {
		...
		Weight::from_parts(20_093_000, 0)
	...
	fn mint_with_external_uri(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_387_949, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			// Standard Error: 721
			.saturating_add(Weight::from_parts(4_325, 0).saturating_mul(s.into()))
	...
	fn evolve_with_external_uri(_s: u32, ) -> Weight {
		...
		Weight::from_parts(14_258_973, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
