...
impl<T: frame_system::Config> pallet_laos_evolution::WeightInfo for WeightInfo<T> {
	...
	fn create_collection() -> Weight {
		...
		Weight::from_parts(21_585_000, 0)
	...
	fn mint_with_external_uri(_s: u32, ) -> Weight {
		...
		Weight::from_parts(38_766_902, 0)
	...
	fn evolve_with_external_uri(s: u32, ) -> Weight {
		...
		Weight::from_parts(14_967_854, 0)
			.saturating_add(Weight::from_parts(0, 4051))
			// Standard Error: 157
			.saturating_add(Weight::from_parts(1_829, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `LaosEvolution::CollectionOwner` (r:1 w:0)
