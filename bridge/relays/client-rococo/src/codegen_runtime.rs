        ...
        pub mod pallet_im_online {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    ...
                    #[codec(index = 2)]
                    SomeOffline {
                        offline: ::std::vec::Vec<(::sp_core::crypto::AccountId32, ())>,
                    },
                }
            }
            pub mod sr25519 {
        ...
        pub mod pallet_membership {
            ...
            pub mod pallet {
                ...
                pub enum Call {
                    ...
                    #[codec(index = 3)]
                    reset_members {
                        members: ::std::vec::Vec<::sp_core::crypto::AccountId32>,
                    },
                    #[codec(index = 4)]
                    change_key {
                        new: ::subxt::utils::MultiAddress<::sp_core::crypto::AccountId32, ()>,
        ...
        pub mod pallet_society {
            ...
            pub mod pallet {
                ...
                pub enum Event {
                    #[codec(index = 0)]
                    Founded {
                        founder: ::sp_core::crypto::AccountId32,
                    },
                    #[codec(index = 1)]
                    Bid {
                    ...
                    #[codec(index = 16)]
                    SkepticsChosen {
                        skeptics: ::std::vec::Vec<::sp_core::crypto::AccountId32>,
                    },
                }
            }
            #[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq)]
        ...
        pub mod rococo_runtime {
            ...
            pub mod validator_manager {
                ...
                pub mod pallet {
                    ...
                    pub enum Event {
                        #[codec(index = 0)]
                        ValidatorsRegistered(::std::vec::Vec<::sp_core::crypto::AccountId32>),
                        #[codec(index = 1)]
                        ValidatorsDeregistered(::std::vec::Vec<::sp_core::crypto::AccountId32>),
                    }
                }
            }
            #[derive(:: codec :: Decode, :: codec :: Encode, Clone, Debug, PartialEq)]
            pub enum OriginCaller {
                ...
                #[codec(index = 14)]
                Council(
                    runtime_types::pallet_collective::RawOrigin<::sp_core::crypto::AccountId32>,
                ),
                #[codec(index = 15)]
                TechnicalCommittee(
                    runtime_types::pallet_collective::RawOrigin<::sp_core::crypto::AccountId32>,
