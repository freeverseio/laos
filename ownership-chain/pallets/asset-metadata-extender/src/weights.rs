...
// --extrinsic=*
// --output=./ownership-chain/pallets/asset-metadata-extender/src/weights.rs
// --chain=dev
...
impl<T: frame_system::Config> pallet_asset_metadata_extender::WeightInfo for WeightInfo<T> {
	...
	fn create_token_uri_extension(t: u32, u: u32, ) -> Weight {
		...
		//  Measured:  `4`
		//  Estimated: `4545`
		// Minimum execution time: 11_855_000 picoseconds.
		Weight::from_parts(12_769_221, 0)
			.saturating_add(Weight::from_parts(0, 4545))
			// Standard Error: 88
			.saturating_add(Weight::from_parts(8_011, 0).saturating_mul(t.into()))
			// Standard Error: 88
			.saturating_add(Weight::from_parts(839, 0).saturating_mul(u.into()))
