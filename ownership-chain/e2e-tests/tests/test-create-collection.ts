...
describeWithFrontier("Frontier RPC (NewCollection)", (context) => {
    const STATE_OVERRIDE_TEST_CONTRACT_BYTECODE = LaosEvolution.bytecode;
    ...
    //     this.timeout(15000);
    //     contract = new context.web3.eth.Contract(LaosEvolution.abi as AbiItem[]);
    //     const data = contract
    //         .deploy({
