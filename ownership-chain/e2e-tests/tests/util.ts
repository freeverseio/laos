...
import { CONTRACT_ADDRESS, GAS_LIMIT, GAS_PRICE, GENESIS_ACCOUNT, GENESIS_ACCOUNT_PRIVATE_KEY, LAOS_EVOLUTION_ABI, EVOLUTION_COLLECTION_ABI, MAX_U96, RPC_PORT } from "./config";
