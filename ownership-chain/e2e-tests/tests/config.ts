...
import CollectionEvolverAndMinter from "../build/contracts/CollectionEvolverAndMinter.json";
...
export const COLLECTION_EVOLVER_AND_MINTER_ABI = CollectionEvolverAndMinter.abi as AbiItem[];
...
export const SELECTOR_LOG_EVOLVED_WITH_EXTERNAL_TOKEN_URI = "0xdde18ad2fe10c12a694de65b920c02b851c382cf63115967ea6f7098902fa1c8";
